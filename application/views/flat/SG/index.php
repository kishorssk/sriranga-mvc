...
<div class="container second-stage">
	<div class="row">
		<div class="col-md-4">
			...
			<div class="mt-3">
				<h5 style="color: #9a291c;">Volumes</h5>
				<ol class="tocentries">
		...
		<div class="col-md-8">
			...
			<p class="text-center mt-2"><button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-success">Order online</button><br /><small>(Shipping will start from 2nd week of January 2020)</small></p>
